...
function parseArgs(options) {
  ...
  } else if (file.exists('lnico.json')) {
    config = path.resolve('lnico.json');
  } else if (file.exists('lnico.js')) {
    config = path.resolve('lnico.js');
  }
  if (config) {

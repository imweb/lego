...
- fix glob patten parse problem of `**/*`, [lego#1073](https://github.com/imweb/lego/issues/1073)

## 1.0.0

1.x for lego3, 0.x for lego2.

- using gulp-lego
- improve performance (e.g. legorar-dialog, from 1.5s to 0.6s)
- 95+ test coverage
